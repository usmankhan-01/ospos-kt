...
class Item extends CI_Model
{
	...
	*/
	public function item_exists($item_number, $include_deleted = FALSE)
	{
		$this->db->from('items');
	...
	*/
	...
	/* get the list of non deleted items */
	public function get_list()
	{
		$this->db->select('items.item_id as item_id');
		$this->db->select('items.item_number as barcode');
		$this->db->select('items.name as name');
		$this->db->select('items.cost_price as wholesale_price');
		$this->db->select('items.unit_price as retail_price');
	...
	*/
	...
	{
		// search first by bracode number
		$this->db->from('items');

...
class Summary_payments extends Summary_report
{
	...
	public function getData(array $inputs)
	{
		...
		$payment_amount = 'SUM(sales_items.item_unit_price * sales_items.quantity_purchased - ROUND((sales_items.item_unit_price * sales_items.quantity_purchased * sales_items.discount_percent / 100), ' . $decimals . '))';
		
		$this->db->select('sales_payments.payment_type, COUNT(DISTINCT sales_payments.sale_id) AS count, ' . $payment_amount . ' AS payment_amount');

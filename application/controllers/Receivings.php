...
class Receivings extends Secure_Controller
{
	...
	public function complete()
	{
		...
		$data['payments'] = $this->receiving_lib->get_receiving_payments();

		//SAVE receiving to database
		$data['receiving_id'] = 'RECV ' . $this->Receiving->save($data['cart'], $supplier_id, $employee_id, $data['comment'], $data['reference'], $data['payment_type'], $data['stock_location'], $data['total'], $data['payments']);
	...
	public function add_payment()
	{
		...
		$this->receiving_lib->add_receiving_payment($payment_type, $amount_tendered);
	...
	{
		$this->receiving_lib->delete_receiving_payment($payment_id);
	...
	private function _reload($data = array())
	{
		...
		$data['total'] = $this->receiving_lib->get_total();
		$data['total_payments'] = $this->receiving_lib->get_receiving_payments_total();
		$data['payments_cover_total'] = $data['total_payments'] > 0 ? $data['total'] == $data['total_payments'] : false;

				...
				?>
					<?php echo form_open($controller_name."/complete", array('id'=>'finish_receiving_form', 'class'=>'form-horizontal')); ?>
						<div class="form-group form-group-sm">
							...
							<table class="sales_table_100" id="payment_details" style="margin-bottom: 0.4em;">
								<tr>
...
$(document).ready(function()
{
    ...
    {
		$('#finish_receiving_form').attr('action', '<?php echo site_url($controller_name."/add_payment"); ?>');
		$('#finish_receiving_form').submit();
    });

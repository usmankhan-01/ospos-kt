<?php $this->lang->load("calendar"); $this->lang->load("date");
	...
	$start_m = $start_d = $start_y = 0;
	sscanf($start_date, "%d-%d-%d", $start_y, $start_m, $start_d);

	$end_m = $end_d = $end_y = 0;
	sscanf($end_date, "%d-%d-%d", $end_y, $end_m, $end_d);
...
?>
		...
		$('#daterangepicker').daterangepicker({
			...
			"startDate": "<?php echo date($this->config->item('dateformat'), mktime(0,0,0,$start_m,$start_d+1,$start_y)-1);?>",
			"endDate": "<?php echo date($this->config->item('dateformat'), mktime(0,0,0,$end_m,$end_d+1,$end_y)-1);?>",
...
?>
		...
		$('#daterangepicker').daterangepicker({
			...
			"alwaysShowCalendars": true,
			"startDate": "<?php echo date($this->config->item('dateformat')." ".$this->config->item('timeformat'),mktime(0,0,0,$start_m,$start_d,$start_y));?>",
			"endDate": "<?php echo date($this->config->item('dateformat')." ".$this->config->item('timeformat'),mktime(23,59,59,$end_m,$end_d,$end_Y));?>",

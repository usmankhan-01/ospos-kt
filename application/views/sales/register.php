	...
	<?php echo form_open($controller_name."/add", array('id'=>'add_item_form', 'class'=>'form-horizontal panel panel-default')); ?>
		<div class="panel-body form-group">
			<ul>
				...
				<li class="pull-left">
					<button id='item_list_button' class='btn btn-info btn-sm pull-left modal-dlg' data-btn-ok='<?php echo $this->lang->line('common_ok') ?>' data-btn-cancel='<?php echo $this->lang->line('common_cancel')?>' data-href='<?php echo site_url("items/get_list"); ?>'
							title='<?php echo $this->lang->line($controller_name . '_item_list'); ?>'>
						<span class="glyphicon glyphicon-th-list">&nbsp</span><?php echo $this->lang->line($controller_name. '_item_list'); ?>
					</button>
				</li>
				<li class="pull-right">
